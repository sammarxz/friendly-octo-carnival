  ...
  return (
    <section className="p-4 h-full">
      <div className="flex justify-between items-center">
        <h2 className="text-gray-800 font-heading font-bold">Satisfication</h2>
      ...
      <div className="flex justify-center">
        ...
        >
          ...
          <animated.circle
            ...
            fill="#fff"
          />
          <circle cx="140" cy="350" r="5" fill="#FF402B" />
          <circle
          ...
          <circle
            ...
            fill="#FF402B"
          />
          <circle cx="560" cy="349.99999999999994" r="5" fill="#FF402B" />
          <path
      ...
      <div className="flex justify-center">
        <div className="flex justify-between mt-2" style={{ width: "300px" }}>
          <div className="pl-8">0%</div>
          <div className="text-center w-[150px]">
            <div className="font-bold text-primary-500">97.78%</div>
            <div className="">Based on Likes</div>
          </div>
          <div className="w-[50px]">100%</div>
        </div>
      </div>
    </section>
  );
};
export { Satisfication };
